      ...
      <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20 mt-6'>
        ...
        className='w-full px-4 py-2 text-xl text-gray-700 bg-white border
         ...
         <div className=' flex justify-between whitespace-nowrap text-sm sm:text-lg'>
          <p className='mb-6'>
            Don't have account ? <Link to="/sig-up" className='text-red-500 hover:text-red-700 transition duration-150 ease-in-out ml-1'>Register</Link>
          </p>
          <p>
          Have account ?<Link to="/sig-in" className='text-blue-500 hover:text-blue-700 transition duration-150 ease-in-out ml-1 '>sig-in</Link>
          </p>
         </div>
         ...
         active:bg-blue-800 ' >SEND RESET PASSWORD</button>
